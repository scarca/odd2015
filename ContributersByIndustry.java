...
public class ContributersByIndustry implements Runnable {
	...
	public void run() {
		// Location of the sector codes file
		File sectorCodes = new File("src/src/Sector_Codes.csv");
	...
	public static int[] contributors(String s) {
		...
		try {
			/*
			 * If the arraylist containing all the contributions is empty, then
			 * it will add the contributions from the contributions file
			 */
